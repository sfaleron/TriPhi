...
# The parameters for the standard figure are generated by a=120
# and b is set to the larger of the values matched by that angle.
...
from simplesvg.lib.math import pi, sqrt, sin, cos, dist
